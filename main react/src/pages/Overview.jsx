  ...
  return (
    <>
      <Container fluid="xxl" className="pt-1nav min-vh-100">
        ...
        <div className="teacher-info-container d-flex flex-row justify-content-between">
          ...
          <div className="d-flex flex-column teacher-subjects">
            ...
            {teacher?.subjects.length > 0 ? (
              teacher.subjects.map((item, index) => (
                <div className="teacher-subject" key={index}>
          ...
          <div className="d-flex flex-column teacher-add-subject">
            ...
            <AddSubject
              ...
              options={options.filter(
                (item) => !teacherSubjects.some((element) => element === item),
              )}
            />
            {loadAddSub && <Loading />}
